...
*/
func NewHttpClient(httpClientConfig config2.HttpClientConfig) HttpClientInterface {
...
func NewHttpClientWithCookies(cookieUrl string, cookies []*http.Cookie, config config2.HttpClientConfig) HttpClientInterface {
