...
const NoteContentMaxLength = 5000
...
type Note struct {
	...
	Status     string    `gorm:"column:status;not null;index:idx_note_status" json:"status" binding:"required,oneof=SET RUNNING SUCCESS FAIL MISSED JUST_LOSS BROKEN"`
	Content    string    `gorm:"column:content;not null" json:"content" binding:"required,max=5000"`
...
type NoteQuery struct {
	Status string `form:"note_status" binding:"omitempty,oneof=SET RUNNING SUCCESS FAIL MISSED JUST_LOSS BROKEN"`
}
