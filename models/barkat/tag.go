...
type Tag struct {
	...
	TagType   string    `gorm:"column:tag_type;not null;index:idx_tag_entry_type,priority:2;index:idx_tag_type_value,priority:1" json:"tag_type" binding:"required,oneof=reason management"`
