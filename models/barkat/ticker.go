...
type Ticker struct {
	...
	InvestingTickers   []InvestingTicker `gorm:"foreignKey:TickerID;references:ID" json:"investing_tickers,omitempty"`
...
type InvestingTicker struct {
	ID          uint64    `gorm:"column:id;primaryKey;autoIncrement" json:"-"`
	TickerID    uint64    `gorm:"column:tradingview_ticker_id;not null;index:idx_investing_ticker_parent" json:"-"`
	Symbol      string    `gorm:"column:symbol;uniqueIndex;not null" json:"symbol"`
	PairID      string    `gorm:"column:pair_id;not null;index:idx_investing_ticker_pair_id" json:"pair_id"`
	DisplayName string    `gorm:"column:display_name;not null" json:"display_name"`
	Exchange    *string   `gorm:"column:exchange;index:idx_investing_ticker_exchange" json:"exchange"`
...
type PriceAlert struct {
	ID                uint64    `gorm:"column:id;primaryKey;autoIncrement" json:"-"`
	InvestingTickerID uint64    `gorm:"column:investing_ticker_id;not null;index:idx_price_alert_investing_ticker" json:"-"`
