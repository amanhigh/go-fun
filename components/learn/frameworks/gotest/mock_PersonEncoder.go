...
func (_c *MockEncoder_DecodePerson_Call) Return(person Person, err error) *MockEncoder_DecodePerson_Call {
...
// EncodePerson provides a mock function with given fields: person
func (_m *MockEncoder) EncodePerson(person Person) (string, error) {
...
//   - person Person
func (_e *MockEncoder_Expecter) EncodePerson(person interface{}) *MockEncoder_EncodePerson_Call {
	return &MockEncoder_EncodePerson_Call{Call: _e.mock.On("EncodePerson", person)}
}

func (_c *MockEncoder_EncodePerson_Call) Run(run func(person Person)) *MockEncoder_EncodePerson_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(Person))
	})
	return _c
