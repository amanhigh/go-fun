...
echo "\033[1;32m Import Public Keys \033[0m \n";
...
#duplicity restore --encrypt-key=$KEY_ID $BACKUP_FILE Restore/
#
#echo "\033[1;33m Verifying Backup \033[0m \n";
#duplicity verify $BACKUP_FILE Restore --compare-data --encrypt-key=$KEY_ID
