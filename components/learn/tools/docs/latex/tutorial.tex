...
\begin{enumerate}
  ...
  \item \emph{nameref} allows you to display name. Eg. \nameref{sec:acronyms}
...
These can now be printed in its own section using \emph{printglossary}.
...
\begin{itemize}
  ...
  \item Modify workshop \href{https://github.com/James-Yu/LaTeX-Workshop/issues/238}{recipies} to make acronyms \Ref{sec:acronyms} work.
\end{itemize}
