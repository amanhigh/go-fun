    ...
    Context("EnrollCmd", func() {
        ...
        Context("without metadata, uses default stamps", func() {
            BeforeEach(func() {
                ctxMatcher := mock.MatchedBy(func(c context.Context) bool {
                    return common.CorrelationFrom(c) == cmd.EnrollmentID &&
                        common.CausationFrom(c) == msg.UUID
                })
                cmdMatcher := mock.MatchedBy(func(in fun.EnrollCmdV1) bool {
                    return in.EnrollmentID == cmd.EnrollmentID && in.PersonID == cmd.PersonID && in.Grade == cmd.Grade
                })
                managerMock.EXPECT().EnrollCmd(ctxMatcher, cmdMatcher).Return(nil)
        ...
        Context("with metadata, overrides correlation and causation", func() {
            BeforeEach(func() {
                ...
                ctxMatcher := mock.MatchedBy(func(c context.Context) bool {
                    return common.CorrelationFrom(c) == "meta-corr" &&
                        common.CausationFrom(c) == "meta-cause"
                })
        ...
        Context("nil message context falls back to background ctx", func() {
            BeforeEach(func() {
                ...
                ctxMatcher := mock.MatchedBy(func(c context.Context) bool {
                    return c != nil &&
                        common.CorrelationFrom(c) == cmd.EnrollmentID &&
                        common.CausationFrom(c) == msg.UUID
                })
                cmdMatcher := mock.MatchedBy(func(in fun.EnrollCmdV1) bool { return in.EnrollmentID == cmd.EnrollmentID })
                managerMock.EXPECT().EnrollCmd(ctxMatcher, cmdMatcher).Return(nil)
