...
func (_m *AlphaClient) FetchDailyPrices(ctx context.Context, ticker string) (fa.StockData, common.HttpError) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, string) (fa.StockData, common.HttpError)); ok {
		return rf(ctx, ticker)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) fa.StockData); ok {
		r0 = rf(ctx, ticker)
	} else {
		r0 = ret.Get(0).(fa.StockData)
	}
...
func (_c *AlphaClient_FetchDailyPrices_Call) Return(_a0 fa.StockData, _a1 common.HttpError) *AlphaClient_FetchDailyPrices_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AlphaClient_FetchDailyPrices_Call) RunAndReturn(run func(context.Context, string) (fa.StockData, common.HttpError)) *AlphaClient_FetchDailyPrices_Call {
	_c.Call.Return(run)
	return _c
}
