import type { JournalTimeframe, JournalStatus, JournalNoteFormat, JournalTagType, JournalType, JournalTopTimeframe, JournalImageType } from './enums';
import type { PaginatedResponse } from '../common';

export type JournalImage = {
	id: string;
	timeframe: JournalTimeframe;
	image_type: JournalImageType;
	file_name: string;
	created_at: string;
};
