...
// GenerateTaxSummaryExcel provides a mock function with given fields: ctx, summary
func (_m *ExcelManager) GenerateTaxSummaryExcel(ctx context.Context, summary tax.Summary) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, tax.Summary) error); ok {
		r0 = rf(ctx, summary)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *ExcelManager_GenerateTaxSummaryExcel_Call) Run(run func(ctx context.Context, summary tax.Summary)) *ExcelManager_GenerateTaxSummaryExcel_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(tax.Summary))
	})
	return _c
}

func (_c *ExcelManager_GenerateTaxSummaryExcel_Call) Return(_a0 error) *ExcelManager_GenerateTaxSummaryExcel_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ExcelManager_GenerateTaxSummaryExcel_Call) RunAndReturn(run func(context.Context, tax.Summary) error) *ExcelManager_GenerateTaxSummaryExcel_Call {
	_c.Call.Return(run)
	return _c
}
