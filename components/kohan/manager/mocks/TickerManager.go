...
// DownloadTicker provides a mock function for the type TickerManager
func (_mock *TickerManager) DownloadTicker(ctx context.Context, ticker string) common.HttpError {
...
// GetPrice provides a mock function for the type TickerManager
func (_mock *TickerManager) GetPrice(ctx context.Context, ticker string, date time.Time) (float64, common.HttpError) {
	ret := _mock.Called(ctx, ticker, date)
	...
	var r0 float64
	var r1 common.HttpError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, time.Time) (float64, common.HttpError)); ok {
		return returnFunc(ctx, ticker, date)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, time.Time) float64); ok {
		r0 = returnFunc(ctx, ticker, date)
	} else {
		r0 = ret.Get(0).(float64)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, time.Time) common.HttpError); ok {
		r1 = returnFunc(ctx, ticker, date)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(common.HttpError)
		}
...
func (_c *TickerManager_GetPrice_Call) Return(f float64, httpError common.HttpError) *TickerManager_GetPrice_Call {
