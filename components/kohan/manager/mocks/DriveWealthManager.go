...
// GenerateCsv provides a mock function with given fields: info
func (_m *DriveWealthManager) GenerateCsv(info tax.DriveWealthInfo) error {
	ret := _m.Called(info)
...
func (_e *DriveWealthManager_Expecter) GenerateCsv(info interface{}) *DriveWealthManager_GenerateCsv_Call {
	return &DriveWealthManager_GenerateCsv_Call{Call: _e.mock.On("GenerateCsv", info)}
}

func (_c *DriveWealthManager_GenerateCsv_Call) Run(run func(info tax.DriveWealthInfo)) *DriveWealthManager_GenerateCsv_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(tax.DriveWealthInfo))
	})
	return _c
}
...
func (_c *DriveWealthManager_GenerateCsv_Call) RunAndReturn(run func(tax.DriveWealthInfo) error) *DriveWealthManager_GenerateCsv_Call {
	_c.Call.Return(run)
	return _c
}
