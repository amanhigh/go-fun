...
var _ = BeforeSuite(func() {
	...
	imageHandler := handler.NewImageHandler(manager.NewImageManager(journalMgr, repository.NewImageRepository(util.NewBaseDbRepository(db))))
	noteHandler := handler.NewNoteHandler(manager.NewNoteManager(journalMgr, repository.NewNoteRepository(util.NewBaseDbRepository(db))))
	tagHandler := handler.NewTagHandler(manager.NewTagManager(journalMgr, repository.NewTagRepository(util.NewBaseDbRepository(db))))
	...
	auditRepo := repository.NewAuditRepository(util.NewBaseDbRepository(db))
