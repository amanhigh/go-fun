...
curl -s -X PUT --data-binary @../opa/authz.rego http://docker:8181/v1/policies/gofun/authz > /dev/null
echo -en "\033[1;34m Policy: http://docker:8181/v1/policies/gofun/authz \033[0m \n"
...
#TODO: Fix Allow Returning False
